...
/**
 * Configuração de segurança baseada em JWT (Auth0) alinhada aos demais microserviços.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    /**
     * Converte claims de JWT em authorities Spring Security, suportando scopes e permissões Auth0.
     */
    @Bean
    ...
    /**
     * Valida que o JWT contém a audiência esperada (API Identifier no Auth0).
     */
